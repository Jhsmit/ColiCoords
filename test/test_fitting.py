...
class TestCellFitting(ArrayTestCase):
    ...
    def test_multiprocessing_brightfield(self):
        ...
        if platform.system() == 'Linux':
            ...
            obj_values = [10016887.213015744, 23617786.724680573, 8999333.060823418, 29339637.500605628,
                          62892422.08723144, 20011819.274376377, 33025293.22872089, 112600585.35048027]
        else:
